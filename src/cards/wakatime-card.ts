...
import type { WakaTimeLang, WakaTimeData } from "../fetchers/types.js";
...
const createCompactLangNode = ({
  ...
  const color =
    (languageColors as Record<string, string>)[lang.name] || "#858585";
  ...
  if (layout === "compact") {
    ...
    const compactProgressBar = filteredLanguages
      .map((language) => {
        ...
        const languageColor =
          (languageColors as Record<string, string>)[language.name] ||
          "#858585";
