 ...
 */
const isPreviewComment = (inputs: any, comment: any) => {
  return (
 ...
 */
const getWebAimLink = (color1: string, color2: string) => {
 ...
 */
const getGRSLink = (colors: Record<string, string>) => {
 ...
 */
const themeNameAlreadyExists = (name: string) => {
